...
Strategický audit subdomén nesmí skončit jako jednorázový workshop s PowerPointem v share-pointu. Cílem auditu je **zaktualizovat investiční prioritu na další 12–18 měsíců**: kde porostou týmy, kde se bude škrtat, co se bude outsourcovat. Bez tohoto výstupu je workshop nákladnou ztrátou času.
...
Domain Vision Statement (DVS) je krátký dokument, který pro Core subdoménu definuje *co, proč, kdo, kdy*. Inspirovaný Evansovou kapitolou 15, ale zkrácený do agilního formátu – 15–20 řádků markdown:
