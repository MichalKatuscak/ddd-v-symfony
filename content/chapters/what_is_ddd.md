...
DDD se v praxi nejčastěji srovnává se čtyřmi jinými přístupy. Žádný z nich není přímý konkurent – některé řeší jinou vrstvu problému, jiné vystačí pro jednodušší případy:
