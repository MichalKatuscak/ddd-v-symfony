...
- **Nevhodnost pro jednoduché aplikace** – DDD se hodí pro složité aplikace s bohatou doménou. Pro jednoduché aplikace s minimální doménovou logikou může být zbytečně složitý a nákladný.
