...
Typický postup zavedení DDD na projektu má osm kroků. Tři první jsou strategické, ostatní spadají do taktiky a iterace.

1. **Pochopit doménu** – Mluvte s experty. Rozhovory, workshopy, modelování na tabuli. Bez této fáze model padá hned na začátku.
2. **Vytvořit Ubiquitous Language** – Definujte společný slovník vývojářů a doménových expertů. Zapište ho a průběžně aktualizujte.
3. **Identifikovat Bounded Contexts** – Rozdělte doménu na menší kontexty s explicitními hranicemi.
4. **Vytvořit Context Map** – Popište vztahy mezi kontexty a způsob jejich integrace.
5. **Modelovat doménu** – Pro každý bounded context vytvořte doménový model, který zachycuje podstatné koncepty a vztahy.
6. **Implementovat taktické vzory** – Entity, Value Object, Aggregate, Repository a další vzory, které model přenesou do kódu.
7. **Testovat** – Ověřte, že model věrně zachycuje doménové chování.
8. **Iterovat** – Model upravujte podle zpětné vazby od expertů a zkušeností z provozu.
...
- **Testovatelnost** – Doménové objekty bez infrastrukturních závislostí jdou testovat v izolaci bez mockování (viz [kapitola o testování](/testovani-ddd)).
...
Druhá strana mince. Před rozhodnutím o DDD znejte i tyto náklady:
...
- **Potřeba doménových expertů** – Bez přístupu k expertovi nemá kdo říct, jaká pravidla skutečně platí. Žádný senior si je nedokáže odvodit z wireframů.
...
DDD se v praxi nejčastěji srovnává se čtyřmi jinými přístupy. Žádný z nich není konkurent v plném smyslu – některé řeší jinou vrstvu problému, jiné vystačí pro jednodušší případy:
...
DDD staví modelování domény do středu návrhu a dává tomu konkrétní vzory. Tři vrstvy, kterými prochází:
...
Zdroje, na kterých stojí celá tato kapitola:
