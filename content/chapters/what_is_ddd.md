...
## 01.03 Základní principy DDD {#principles}
...
2. **Ubiquitous Language** – DDD prosazuje společný jazyk vývojářů a doménových expertů, který se promítá do kódu, dokumentace i komunikace.
