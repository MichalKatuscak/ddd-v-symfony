...
Po šesti měsících má tým 40 agregátů, 80 doménových událostí a 200 commandů. Kód vypadá jako z učebnice. Ale skutečná pravidla skladu (kdy zboží může být rezervováno na dvou místech současně, jak se rozhoduje o přesunu mezi sklady, jaký je vztah mezi rezervací a skutečným fyzickým výdejem) v modelu nikdy nebyla. Tým modeluje vlastní představu domény; skutečná pravidla zůstávají mimo model.

Když logistický ředitel po dvou měsících provozu zjistí, že systém umožňuje dvojí rezervaci (a tím způsobuje časté reklamace), vyžaduje okamžitou opravu. Refaktor 40 agregátů a 80 událostí trvá čtyři měsíce. Po čtrnácti měsících vývoje je projekt na technologii za 30 % funkcionality, kterou původní CRUD aplikace zvládala.
